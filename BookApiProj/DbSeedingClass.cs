                    ...
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review {
                                ...
                                ReviewText = "Reviewing Call of the Wild and it is awesome beyond words",
                                Rating = 5,
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review
                            {
                                Headline = "Good Romantic Book",
                                ReviewText = "This book made me cry a few times",
                                Rating = 5,
                                Reviewer = new Reviewer()
                                {
                                    FirstName = "Allison",
                            ...
                            new Review {
                                ...
                                ReviewText = "My wife made me read it and I hated it",
                                Rating = 1,
                             Reviewer = new Reviewer()
                             {
